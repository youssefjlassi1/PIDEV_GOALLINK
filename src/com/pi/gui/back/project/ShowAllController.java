...
public class ShowAllController implements Initializable {
    ...
    public Parent makeProjectModel(
        ...
        try {
            ...
            ((Button) innerContainer.lookup("#generatePDFButton")).setOnAction((event) -> genererPDF(project));
    ...
    private void genererPDF(Project project) {
        ...
        try {
            ...
            try {
                com.itextpdf.text.Image image = com.itextpdf.text.Image.getInstance(project.getImage());
            ...
            document.add(new Paragraph("Owner : " + project.getOwner()));
            document.add(new Paragraph("Name : " + project.getName()));
            document.add(new Paragraph("Theme : " + project.getTheme()));
            document.add(new Paragraph("Status : " + project.getStatus()));
            document.add(new Paragraph("Image : " + project.getImage()));
            document.add(new Paragraph("Description : " + project.getDescription()));
            document.add(new Paragraph("Location : " + project.getLocation()));
            document.add(new Paragraph("Created : " + project.getCreated()));
            document.add(new Paragraph("Updated : " + project.getUpdated()));
            document.add(new Paragraph("Nom : " + project.getName()));
            document.add(new Paragraph("Description : " + project.getDescription()));
            document.newPage();
            document.close();
