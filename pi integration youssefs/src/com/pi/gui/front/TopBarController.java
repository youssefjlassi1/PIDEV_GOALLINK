...
public class TopBarController implements Initializable {
    ...
    private final Color COLOR_PRIMARY = Color.web("#E5003F");
    ...
    @FXML
    private Button btnDonationUser;

    @FXML
    private AnchorPane mainComponent;
    @FXML
    private Button btnTaskss;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btnProjects.setTextFill(COLOR_DARK);
    }

    @FXML
    private void afficherProjects(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_DISPLAY_ALL_PROJECT);

        btnProjects.setTextFill(COLOR_PRIMARY);
        Animations.animateButton(btnProjects, COLOR_GRAY, Color.WHITE, COLOR_PRIMARY, 0, false);
    }
     @FXML
    private void afficherTasks(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_DISPLAY_ALL_TASK);

        btnProjects.setTextFill(COLOR_PRIMARY);
        Animations.animateButton(btnTaskss, COLOR_GRAY, Color.WHITE, COLOR_PRIMARY, 0, false);
    }

    @FXML
    private void afficherDonations(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_DISPLAY_ALL_DONATION);
    ...
    @FXML
    private void afficherDonationUser(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_DISPLAY_ALL_DONATION_USER);

        btnDonationUser.setTextFill(COLOR_PRIMARY);
        Animations.animateButton(btnDonationUser, COLOR_GRAY, Color.WHITE, COLOR_PRIMARY, 0, false);
    }
